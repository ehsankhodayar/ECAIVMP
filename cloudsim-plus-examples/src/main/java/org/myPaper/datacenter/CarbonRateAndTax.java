...
public class CarbonRateAndTax{
    ...
    /**
     * Gets the rate of carbon footprint in tons/MWh at this data center.
     *
     * @return carbon footprint rate (tons/MWh)
     */
    public double getCarbonFootprintRate() {
        return carbonFootprintRate;
    }

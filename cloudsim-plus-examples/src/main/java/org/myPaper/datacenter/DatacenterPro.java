...
public class DatacenterPro extends DatacenterSimple {
    ...
    public DatacenterPro(Simulation simulation, List<? extends Host> hostList, final DatacenterBroker broker) {
        this(simulation, hostList, new VmAllocationPolicySimple(), broker);
    }

    public DatacenterPro(Simulation simulation, List<? extends Host> hostList, VmAllocationPolicy vmAllocationPolicy, final DatacenterBroker broker) {
    ...
    public double getTotalCarbonFootprint(double energyConsumption) {
        return carbonRateAndTaxModel.getTotalCarbonFootprint(energyConsumption);
    }

    public CarbonRateAndTax getCarbon() {
        return carbonRateAndTaxModel;
    }

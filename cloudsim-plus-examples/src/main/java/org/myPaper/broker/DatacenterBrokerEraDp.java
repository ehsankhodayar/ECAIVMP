...
public class DatacenterBrokerEraDp extends DatacenterBrokerMain {
     ...
     */
    public DatacenterBrokerEraDp(CloudSim simulation, String name) {
     ...
     */
    public DatacenterBrokerEraDp(CloudSim simulation, String name, List<Datacenter> datacenterList) {
    ...
    private Datacenter runKhosraviAlgorithm(final Vm vm, List<Datacenter> allowedDatacenterList) {
        ...
        for (Datacenter datacenter : sortedDatacenterList) {
            ...
            List<Host> allowedHostList = new ArrayList<>(datacenter.getHostList());

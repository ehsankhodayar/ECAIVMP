...
import org.myPaper.broker.DatacenterBrokerEraDp;
import org.myPaper.broker.DatacenterBrokerEraFfd;

import java.util.Arrays;
import java.util.Collections;

public class EraFfdProgram extends ParentClass {

    public EraFfdProgram(final String directory, final int workloadsNumber) {
    ...
    private void runProgram() {
        ...
        broker1 = new DatacenterBrokerEraFfd(simulation, "Cloud-Broker-Provider1", Arrays.asList(datacenter1, datacenter2, datacenter3, datacenter4));

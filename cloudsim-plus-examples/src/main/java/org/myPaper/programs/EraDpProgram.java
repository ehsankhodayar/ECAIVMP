...
import org.myPaper.broker.DatacenterBrokerCraDp;
import org.myPaper.broker.DatacenterBrokerEraDp;

import java.util.Arrays;

public class EraDpProgram extends ParentClass {

    public EraDpProgram(final String directory, final int workloadsNumber) {
    ...
    private void runProgram() {
        ...
        broker1 = new DatacenterBrokerEraDp(simulation, "Cloud-Broker-Provider1", Arrays.asList(datacenter1, datacenter2, datacenter3, datacenter4));

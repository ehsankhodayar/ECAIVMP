...
public class CraDpProgram extends ParentClass {
    ...
    public CraDpProgram(final String directory, final int workloadsNumber) {
    ...
    private void runProgram() {
        ...
        broker1 = new DatacenterBrokerCraDp(simulation, "Cloud-Broker-Provider1", Arrays.asList(datacenter1, datacenter2, datacenter3, datacenter4));

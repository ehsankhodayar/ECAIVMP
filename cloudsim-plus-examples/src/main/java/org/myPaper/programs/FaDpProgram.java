...
import org.myPaper.broker.DatacenterBrokerFaDp;

import java.util.Arrays;

public class FaDpProgram extends ParentClass {

    public FaDpProgram(final String directory, final int workloadsNumber) {
    ...
    private void runProgram() {
        ...
        broker1 = new DatacenterBrokerFaDp(simulation, "Cloud-Broker-Provider1", Arrays.asList(datacenter1, datacenter2, datacenter3, datacenter4));

...
import org.myPaper.datacenter.vmAllocationPolicies.VmAllocationPolicyAcsBased;
...
public class DatacenterSolutionEntry {
    ...
    private Map<Vm, Host> constructSolutions(final Datacenter datacenter, final List<Vm> vmList, final List<Host> allowedHostList) {
        ...
        VmAllocationPolicyAcsBased vmAllocationPolicy =
            (VmAllocationPolicyAcsBased) datacenter.getVmAllocationPolicy();
